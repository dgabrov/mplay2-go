...
type PostRemoveMediaFromPlaylistEndpoint struct {
	servr *service.Servr
}

func NewPostRemoveMediaFromPlaylistEndpoint(servr *service.Servr) *PostRemoveMediaFromPlaylistEndpoint {
	return &PostRemoveMediaFromPlaylistEndpoint{
		servr: servr,
	}
}

func (e *PostRemoveMediaFromPlaylistEndpoint) Handle(w http.ResponseWriter, r *http.Request) error {
	ctx := r.Context()
...
func (e *PostRemoveMediaFromPlaylistEndpoint) process(ctx context.Context, r *http.Request) (data.SuccessResponse, error) {
	...
	_, err = e.servr.RemoveMediaFromPlaylist(ctx, userID, req.PlaylistId, req.Ids)
	if err != nil {
		return data.SuccessResponse{}, err
	}
